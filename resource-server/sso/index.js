...
/**
 * https://localhost:3001/(any end point that is part of your API)
 ...
 * refresh tokens.
 *
 * For example, I use this with the https://localhost:3001/infoss like so
 * (see site.js)
 *
 * exports.infosso = [
...
/**
 * https://localhost:3001/receivetoken?code=(authorization code)
 *
